...
1. **Foreground Image**: A fixed, full-screen google gen ai image acts as the foreground for the animation. The image has a subtle wobble animation to simulate a sense of movement or instability.
